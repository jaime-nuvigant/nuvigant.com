---
title: "¿Qué es la Firma Electrónica Avanzada para Notarios y Corredores?"
date: "2020-06-01"
author:
...
Como el nombre lo dice, la Firma Electrónica es una manera de "firmar" documentos de una manera digital. Pongo la palabra firmar entre comillas, porque no es necesariamente hacer una firma autógrafa en una tableta. Lo podemos entender más bien como un símbolo que una persona puede adjuntar a un documento para indicar la intención de firmar el documento.

Esta firma se puede realizar de varias formas, como lo son escanear una huella digital o realizar una firma autógrafa en una tableta en vez de un pedazo de papel y cada una ofrece diferentes niveles de seguridad. Por ejemplo, la firma electrónica más sencilla que se me ocurre es la siguiente:
...
Digamos que Facebook decide empezar a ofrecer el servicio de firma electrónica simple. Supongamos que tú tienes una cuenta de Facebook y yo también. Ahora supongamos que queremos firmar que yo te vendí un vehículo y que me lo pagarás en mensualidades de $700 USD.
...
Es aquí donde entra la Firma Electrónica Avanzada.
...
Varios países ya han implementado el uso y los reglamentos para usar la FES (FIEL). Por ejemplo en La Unión Europea esto se rige por medio de la [Regulación EU No 910/2014 (Regulación-eIDAS)](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=uriserv%3AOJ.L_.2014.257.01.0073.01.ENG) y en México la ley que rige esto es la [Ley de Firma Electrónica Avanzada (LFEA)](https://eservicios.impi.gob.mx/seimpi/ayudaSEIMPI/LFEA.pdf) donde se menciona que la FEA (FIEL) a diferencia de la FES goza de presunciones jurídicas de atribución (no repudio) e integridad (Art. 8, Fracción V).
...
Sin importar tu punto de vista es algo de lo que debemos estar pendientes. [En Chile, por ejemplo, ya se ha eliminado la necesidad de acudir con un notario para realizar ciertos actos para los cuales antes sí era necesario](https://www.notariosyconservadores.cl/alfredo-martin-no-estamos-de-acuerdo-con-que-el-proyecto-de-firma-electronica-avanzada-y-sellado-de-tiempo-reemplacen-la-fe-publica-y-la-seguridad-juridica/).
...
Hacer estos avances fáciles de implementar y entendibles para los notarios es la razón de nuestra existencia. Nosotros, por medio de nuestra [plataforma para notarías](https://nuvigant.com/fedatarios/sistema-notarias), ya ofrecemos la posibilidad de firmar documentos con la Firma Electrónica Avanzada de una manera muy fácil. Hacer esto es el primer paso en nuestra visión de ["Notario en Línea" o "Corredor en Línea"](https://cdn.notariamasmas.com/notario-en-linea), que nosotros creemos ser la evolución natural del nicho ante todos los cambios tecnológicos que se presentan. (Puedes leer más sobre esto dando [click aquí](https://blog.notariamasmas.com/blog/corredor-y-notario-en-l%C3%ADnea).)

![¿Qué-es-la-Firma-Electrónica-Avanzada-para-Notarios-y-Corredores?](/images/blog/que-es-la-firma-electronica-avanzada-para-notarios-y-corredores-body.jpg)

## Una opinión personal

Yo, en lo personal, como alguien tecnológico que tiene mucho que ver con notarios y corredores, creo que es inevitable que ciertos actos sencillos de la fé pública sean muy pronto realizables utilizando únicamente esta y otras tecnologías emergentes (blockchain, smart contracts). Para actos sencillos estas tecnologías pueden, creo yo, ofrecer suficiente confianza.
...
Si te interesaría mantenerte informado de estos cambios, te invitamos a ponerte en contacto con nosotros en [contacto@nuvigant.com](mailto:contacto@nuvigant.com) o agenda una cita para platicar con nosotros dando [click aquí](https://meetings.hubspot.com/calderon-matar). Con mucho gusto podemos platicar más a profundidad sobre todo esto.
