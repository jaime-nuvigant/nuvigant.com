...
1. **Recabar datos de identificación** del cliente y beneficiario final.
2. **Conservar la documentación** de la operación por al menos cinco años.
3. **Enviar avisos a la UIF** dentro del plazo legal (10 días hábiles a partir de la operación).
4. **Establecer controles internos y capacitar a su personal.**

---

![Operaciones-vulnerables-4-cosas-que-todo-notario-debe-saber](/images/blog/operaciones-vulnerables-4-cosas-que-todo-notario-debe-sab-body.jpg)
