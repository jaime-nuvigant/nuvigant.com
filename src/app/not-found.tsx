          ...
          <aside className="nf-notario" aria-hidden="true">
            ...
            <div className="nf-stage">
              <svg viewBox="0 0 260 250" xmlns="http://www.w3.org/2000/svg" style={{ position: "absolute", inset: 0, width: "100%", height: "100%" }}>
                ...
                {/* Dust puffs */}
                <g className="nf-puff">
                  <circle cx="115" cy="100" r="2" style={{ "--tx": "-14px", "--ty": "-6px" } as React.CSSProperties} />
                  <circle cx="145" cy="100" r="2" style={{ "--tx": "14px", "--ty": "-6px" } as React.CSSProperties} />
                  <circle cx="130" cy="115" r="2" style={{ "--tx": "0", "--ty": "10px" } as React.CSSProperties} />
                  <circle cx="120" cy="90" r="1.6" style={{ "--tx": "-10px", "--ty": "-12px" } as React.CSSProperties} />
                  <circle cx="140" cy="90" r="1.6" style={{ "--tx": "10px", "--ty": "-12px" } as React.CSSProperties} />
                </g>
                {/* Stamp */}
