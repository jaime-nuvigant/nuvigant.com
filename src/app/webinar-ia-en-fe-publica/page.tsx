...
const description = "Explora cómo la inteligencia artificial está transformando la fe pública notarial. Regístrate a nuestro webinar gratuito con expertos en derecho y tecnología.";
