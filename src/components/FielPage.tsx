...
import { Shield, Scale, Zap, ArrowRight } from "lucide-react";
      ...
      <section className="relative overflow-hidden bg-white pt-28 pb-20 lg:pt-36 lg:pb-28 text-center">
        ...
        <div className="relative max-w-3xl mx-auto px-6 lg:px-8">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-slate-900 leading-[1.1] tracking-tight mb-6">
            Firma Documentos de la Manera más Confiable
          </h1>
          <p className="text-lg text-slate-500 leading-relaxed mb-10">
            Nuvigant te permite administrar tus documentos, firmarlos y solicitar firmas desde cualquier lugar, en cuestión de minutos.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-14">
            <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 tracking-tight">
              Obtén todos los beneficios de la firma más confiable que existe
            </h2>
            <p className="mt-4 text-slate-600 text-lg max-w-2xl mx-auto">
              Permítele a tus clientes firmar, sin importar dónde se encuentren. Todo por medio de una firma con mucho más valor que una firma autógrafa.
            </p>
          </div>
            ...
            {[
              {
                icon: Shield,
                title: "Seguridad",
                desc: "La llave privada de tu eFirma nunca se comparte con nosotros, de eso puedes estar tranquil@. Este es un error común de otros servicios de eFirma.",
                color: "#056dfe",
                bg: "#eff6ff",
              },
              {
                icon: Scale,
                title: "Legal",
                desc: "Nuestra firma ha sido auditada por expertos en la materia para poderte ofrecer todas sus ventajas.",
                color: "#2ea4f2",
                bg: "#f0f9ff",
                featured: true,
              },
              {
                icon: Zap,
                title: "Rápida",
                desc: "Reduce procesos que antes tomaban semanas a minutos. Olvídate de pedir firmas por paquetería o tener que acomodarte a que tus clientes tengan tiempo de firmar.",
                color: "#51d2e9",
                bg: "#ecfeff",
              },
            ].map(({ icon: Icon, title, desc, color, bg, featured }) => (
              <div
                key={title}
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-12 flex items-center justify-center min-h-[300px]">
              <div className="text-center">
                <div className="w-20 h-20 rounded-full bg-white shadow-lg flex items-center justify-center mx-auto mb-4">
                  <Scale size={40} style={{ color: "#056dfe" }} strokeWidth={1.4} />
                </div>
                <p className="text-slate-700 font-semibold text-lg">Con plena validez jurídica</p>
                <p className="text-slate-500 text-sm mt-2">
                  Respaldada por la Ley Federal de Firma Electrónica Avanzada
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="bg-gradient-to-br from-sky-50 to-blue-50 rounded-2xl p-12 flex items-center justify-center min-h-[300px] order-last lg:order-first">
              <div className="text-center">
                ...
                <p className="text-slate-500 text-sm mt-2">La eFirma y todas las herramientas de Nuvigant en un solo lugar</p>
              </div>
            </div>
            <div>
              <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 tracking-tight mb-6">
