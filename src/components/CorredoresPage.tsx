...
import { BarChart3, FileText, Shield, PenTool, FileCode, Receipt, Bell, ArrowRight } from "lucide-react";
...
const features = [
  ...
  },
  {
    ...
    desc: "Genera tus CFDIs desde donde sea que te encuentres utilizando la información que ya tienes capturada en el software administrativo.",
    color: "#51d2e9",
    bg: "#ecfeff",
  },
];
      ...
      <section className="relative overflow-hidden bg-white pt-28 pb-20 lg:pt-36 lg:pb-28 text-center">
        ...
        <div className="relative max-w-3xl mx-auto px-6 lg:px-8">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-slate-900 leading-[1.1] tracking-tight mb-6">
            Sistema de corredores amigable y que se adapta a tus necesidades.
          </h1>
          <p className="text-lg text-slate-500 leading-relaxed mb-10">
            Nuestro software de gestoría es una solución en la nube que engloba todo lo que necesitas para controlar tu
            correduría en un solo lugar.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-14">
            <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 tracking-tight">
              Administra tu correduría en un solo Lugar
            </h2>
            <p className="mt-4 text-slate-600 text-lg max-w-2xl mx-auto">
              Sistema para corredores que se adapta a tu operación. Nuestro sistema para corredores públicos cuenta con
              varios módulos que puedes usar de manera independiente dependiendo de lo que necesites.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-slate-600 text-lg leading-relaxed mb-4">
                Cada vez más negocios empiezan a trabajar completamente en línea. Esto trae varios beneficios en costos
                al igual que volverte más atractivo al momento de reclutar gente para tu equipo.
              </p>
              <p className="text-slate-600 text-lg leading-relaxed mb-8">
                Nuestro sistema administrativo te permite implementar esquemas más flexibles de trabajo remoto sin que
                tengas que sacrificar el control que llevas sobre tu negocio.
              </p>
              <Link
                href={URL_SCHEDULE_DEMO}
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-12 flex items-center justify-center min-h-[300px]">
              <div className="text-center">
                ...
                <p className="text-slate-700 font-semibold text-lg">Trabajo 100% en línea</p>
                <p className="text-slate-500 text-sm mt-2">Flexibilidad sin perder el control</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="bg-gradient-to-br from-sky-50 to-blue-50 rounded-2xl p-12 flex items-center justify-center min-h-[300px] order-last lg:order-first">
              <div className="text-center">
                <div className="w-20 h-20 rounded-full bg-white shadow-lg flex items-center justify-center mx-auto mb-4">
                  <Bell size={40} style={{ color: "#2ea4f2" }} strokeWidth={1.4} />
                </div>
                <p className="text-slate-700 font-semibold text-lg">Alertas y recordatorios</p>
                <p className="text-slate-500 text-sm mt-2">Nunca te pierdas nada importante</p>
              </div>
            </div>
            <div>
              <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 tracking-tight mb-6">
              ...
              <p className="text-slate-600 text-lg leading-relaxed mb-4">
                No importa si son pagos que tengas que hacer, recordatorios que tengas con tus clientes o proyectos,
              ...
              <p className="text-slate-600 text-lg leading-relaxed mb-8">
                ...
                de lo que ya se hizo y lo que se tiene que hacer.
              </p>
              <Link
                href={URL_SCHEDULE_DEMO}
                className="inline-flex items-center gap-2 text-white font-bold text-sm px-6 py-3 rounded-xl transition-all"
      ...
      >
        <div className="max-w-2xl mx-auto px-6">
          ...
          <p className="text-white/85 text-lg mb-8">
            Nuestro software de corredores públicos se moldea fácilmente a lo que tú necesitas. A nuestros clientes les
            encanta lo fácil que es usarla.
          </p>
          <Link
            href={URL_SCHEDULE_DEMO}
